...
@section('contenido')
<section class="page-title bg-1" style="background-image: url(  '/{{ $testimonio->imagen }}');">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block text-center">
                    ...
                    <h1 class="text-capitalize mb-5 text-lg">{{ $testimonio->nombre }}</h1>
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-5">
                <div class="section-title">
                    ...
                    <h1>LA HISTORIA CLÍNICA DE NUESTRO PACIENTE: {{ $testimonio->nombre }}</h1>
                    <p>
                    <p>{{ $testimonio->descripcion }}</p>

                    </p>
                    <a data-toggle="modal" data-target="#modalagenda" class="btn btn-main-2 btn-round-full mt-3">Haz una cita<i class="icofont-simple-right ml-2  "></i></a>
                </div>
            </div>
    ...
    <div class="container container-adjustment">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="edu-block">
                    <h4 class="mb-3 title-color">{{ $tratamiento->tratamiento->nombre}}</h4>
                    <p>{{ $tratamiento->tratamiento->descripcion }}</p>
                </div>
            </div>
            @endforeach
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                <div class="about-content pl-4 mt-4 mt-lg-0">
                    ...
                    <a href="{{route('nosotros')}}#nuestras-sucursales" class="btn btn-main-2 btn-round-full btn-icon">Sucursales<i class="icofont-simple-right ml-3"></i></a>
                </div>
            </div>
