        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="doctor-details mt-4 mt-lg-0">
                    <h2 class="text-md text-red">AVISO LEGAL Y COOKIES</h2>
                    <div class="divider my-4"></div>
                    <p>Este Aviso Legal tiene el objetivo de informarte de tus derechos y obligaciones como usuario de este sitio web. Aquí encontrarás toda la información que necesitas sobre este sitio web, su actividad, los datos personales que recaba y su finalidad, así como las normas de uso que regulan el uso de esta web.
                    </p>
                    <p>En el momento en que accedas a este sitio web clinicasdentalmas.com, asumes la condición de usuario, por lo que el contenido de este Aviso Legal te afecta directamente. Por eso, es importante que lo leas para disipar cualquier duda que puedas tener y tener conocimiento de causa sobre las condiciones que estás aceptando.</p>
                    ...
                    <p>El <strong>RGPD (Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo de 27 de abril de 2016 relativo a la protección de las personas físicas)</strong> que es la nueva normativa de la Unión Europea que unifica la regulación del tratamiento de los datos personales en los distintos países de la UE.
                    </p>



                    <p>La <strong>LOPD (Ley Orgánica 15/1999, de 13 de diciembre, de Protección de Datos de Carácter Personal </strong>y<strong> Real Decreto 1720/2007, de 21 de diciembre, el Reglamento de desarrollo de la LOPD)</strong> que regula el tratamiento de los datos personales y las obligaciones que debemos asumir los responsables de una web o un blog a la hora de gestionar esta información.
                    </p>

                    <p>La <strong>LSSI (Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y Comercio Electrónico)</strong> que regula las transacciones económicas mediante medios electrónicos, como es el caso de este blog.
                    </p>


                    <h2 class="text-md text-red">DATOS DE IDENTIFICACIÓN</h2>
                    <div class="divider my-4"></div>
                    <p>El responsable y titular de este sitio web es clinicasdentalmas.com</p>
                    <p>Los datos que nos facilites con tu consentimiento, y de acuerdo al uso establecido en nuestra Política de Privacidad, serán incorporados a un fichero automatizado debidamente inscrito. Esto quiere decir que tus datos están seguros, de acuerdo a lo que establece la ley.</p>


                    <h2 class="text-md text-red">NORMAS DE ACCESO AL SITIO WEB</h2>
                    <div class="divider my-4"></div>
                    ...
                    <p>Como titular de este sitio web, clinicasdentalmas.com no garantiza que los contenidos sean precisos o libres de error o que el libre uso de los mismos por parte de los usuarios no infrinja los derechos de terceras partes. El buen o mal uso de esta página y de sus contenidos es responsabilidad del usuario.</p>

                    <p>Asimismo, queda prohibida la reproducción, retransmisión, copia, cesión o redifusión, total o parcial, de la información contenida en la página, cualquiera que fuera su finalidad y el medio utilizado para ello, sin autorización previa.</p>

                    <h2 class="text-md text-red">ENLACES O LINKS</h2>
                    <div class="divider my-4"></div>
                    <p>Este sitio web incluye enlaces o links a sitios de terceros. Las páginas pertenecientes a estos terceros no han sido revisadas ni son objeto de controles por nuestra parte, por lo que clinicasdentalmas.com no podrá ser considerado responsable de los contenidos de estos sitios web, ni de las medidas que se adopten relativas a su privacidad o al tratamiento de sus datos de carácter personal u otros que pudieran derivarse.</p>
                    ...
                    <h2 class="text-md text-red">LIMITACIÓN DE RESPONSABILIDAD</h2>
                    <div class="divider my-4"></div>

                    <p>En ejercicio de su derecho como titular de esta web, te informamos de que clinicasdentalmas.com no se hace responsable en ningún caso de lo siguiente:</p>
                    ...
                    <h2 class="text-md text-red">POLITICA DE PRIVACIDAD Y PROTECCIÓN DE DATOS</h2>
                    <div class="divider my-4"></div>
                    ...
                    <h2 class="text-md text-red">POLÍTICA DE COOKIES</h2>
                    <div class="divider my-4"></div>
                    ...
                    <p>Para acceder a la información completa sobre el uso de cookies en este sitio web, su finalidad y su desestimación, puedes consultar nuestra POLÍTICA DE COOKIES.</p>


                    <h2 class="text-md text-red">LEGISLACIÓN APLICABLE Y JURISDICCIÓN COMPETENTE</h2>
                    <div class="divider my-4"></div>

                    <p>El presente Aviso Legal se encuentra sometido a la legislación española vigente.</p>

                    <p>En caso necesario, ante cualquier tipo de controversia de carácter legal, clinicasdentalmas.com y el usuario, con renuncia expresa a cualquier otro fuero, se someterán a los Juzgados y Tribunales del domicilio del Usuario para cualquier controversia que pudiera derivarse.</p>

                    <p>En el caso de que el usuario tenga su domicilio fuera de México, clinicasdentalmas.com y el usuario se someterán, con renuncia expresa a cualquier otro fuero, a los juzgados y tribunales México.</p>
                    <p>Si tienes cualquier duda sobre este Aviso Legal, puedes enviarnos un correo electrónico a contacto@clinicasdentalmas.com</p>
