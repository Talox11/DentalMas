                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mb-5">
                            ...
                            <h4 class="text-uppercase">Lo sentimos, esta pagina no esta disponilble</h4>
                            <div class="mt-5 text-center">
                                <a class="btn btn-primary waves-effect waves-light" href="{{route('home-web')}}">Regresar a inicio</a>
                            </div>
                        </div>
                    </div>
                </div>
